...
//{
//	if (device->KeyPress(DIK_D) && device->KeyPress(DIK_LEFT))
//	{
//		m_State			= PLAYERSTATES::JUMP::JUMP;
//		m_Direction		= DIRECTION::DIRECTION_LEFT;
//
//	}
//	if (device->KeyPress(DIK_D) && device->KeyPress(DIK_F))
//	{
//		m_State			= PLAYERSTATES::JUMP::JUMP_SHOOT;
//		m_Direction		= DIRECTION::DIRECTION_NONE;
//	}
//	if (device->KeyPress(DIK_D) && device->KeyPress(DIK_F) && device->KeyPress(DIK_RIGHT))
//	{
//		m_State			= PLAYERSTATES::JUMP::JUMP_SHOOT;
//		m_Direction		= DIRECTION::DIRECTION_RIGHT;
//	}
//	if (device->KeyPress(DIK_RIGHT) && device->KeyPress(DIK_F))
//	{
//		m_State = PLAYERSTATES::SHOT::SHOT_JUMP_RIGHT;
//	}
//
//}
//
